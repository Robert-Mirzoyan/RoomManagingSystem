...
//        String query = "INSERT INTO timeslot (start_time, end_time) VALUES (?, ?)";
//        JdbcUtil.execute(query, timeSlot.getStartTime(), timeSlot.getEndTime());
//    }
    ...
    public int getId(TimeSlot timeSlot) {
        ...
        return JdbcUtil.findOne(query, TIME_SLOT_MAPPER, Timestamp.valueOf(start), Timestamp.valueOf(end)).getId();
    }
